...
document.addEventListener('DOMContentLoaded', function() {
	...
	document.getElementById('id_11').setAttribute('innerHTML', 'Hover');
	document.getElementById('id_11').setAttribute('disabled', 'false');
	document.getElementById('id_11').setAttribute('name', 'button1');
	document.getElementById('id_10').setAttribute('checked', 'false');
	document.getElementById('id_10').setAttribute('name', 'Age');
	document.getElementById('id_9').setAttribute('checked', 'false');
	document.getElementById('id_9').setAttribute('innerHTML', 'Female');
	document.getElementById('id_9').setAttribute('name', 'female');
	document.getElementById('id_8').setAttribute('checked', 'false');
	document.getElementById('id_8').setAttribute('innerHTML', 'Male');
	document.getElementById('id_8').setAttribute('name', 'male');
	document.getElementById('id_7').setAttribute('innerHTML', 'Gender:');
	document.getElementById('id_6').setAttribute('maxlength', '8');
	document.getElementById('id_6').setAttribute('name', 'pwBox');
	document.getElementById('id_5').setAttribute('innerHTML', 'Password');});
