...
var abstract_Model_Obj = JSON.parse(fs.readFileSync('./Models/Abstract_Model.json', 'utf-8'));
...
fs.writeFileSync("./Models/CUI_Interaction_STYLE_Model.json", JSON.stringify(STYLE_MODEL))
fs.writeFileSync("./Models/CUI_Interaction_EVENT_Model.json", JSON.stringify(EVENT_MODEL))
