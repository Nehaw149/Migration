...
var abstract_Model_Obj = JSON.parse(fs.readFileSync('./Models/AbstractModel.json', 'utf-8'));
...
fs.writeFileSync("./Models/CUI_Model.json", JSON.stringify(abstract_Model_Obj))
